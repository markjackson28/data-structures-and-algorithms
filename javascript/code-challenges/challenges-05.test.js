...
const toLastNames = people => {
  // Solution code here...
  let namesArr = people.map(name => {
    let firstLast = name.firstName + ' ' + name.lastName;
    return firstLast;
  });
  return namesArr;
};
