...
const typeNum = (arr) => {
  // Solution code here...
  let numbersArr = arr.filter(Number);
  return numbersArr;
};
...
const containsAnd = (arr) => {
  // Solution code here...
  let andArr = arr.filter(andWord => andWord.includes('and'));
  return andArr;
};
...
const oddValues = (arr) => {
  // Solution code here...
  let oddNums = arr.filter(oddNum => oddNum % 2 !== 0);
  return oddNums;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let addNum = arr.filter(num => !forbiddenValues.includes(num));
  return addNum;
};
